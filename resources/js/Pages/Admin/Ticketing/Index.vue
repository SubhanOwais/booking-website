...
const clearFilters = () => {
    ...
    router.get(route("admin.ticketing.index"), {}, { preserveState: true, preserveScroll: true });
    filterOpen.value = false;
};
...
const exportTickets = () => {
    ...
    window.location.href = route("admin.ticketing.export") + (queryString ? "?" + queryString : "");
};
...
const openTicketModal = async (ticketId) => {
    ...
    try {
        const response = await fetch(route("admin.ticketing.show", ticketId), {
            headers: {
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="ticket in tickets.data" :key="ticket.id" class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-3">
                                    <div class="text-xs font-medium text-gray-900 sm:text-sm">{{ ticket.Passenger_Name
                                        }}</div>
                            ...
                            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                                ...
                                <div class="p-5 bg-gray-50 border border-gray-200 rounded-xl">
                                    ...
                                    <dl class="space-y-2.5">
                                        ...
                                        <div class="flex justify-between">
                                            <dt class="text-sm text-gray-500">Seat Number(s)</dt>
                                            <dd class="text-sm font-medium text-gray-900">{{
                            ...
                            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                                ...
                                <div class="p-5 bg-gray-50 border border-gray-200 rounded-xl">
                                    ...
                                    <dl class="space-y-2.5">
                                        ...
                                        <div class="flex justify-between">
                                            <dt class="text-sm text-gray-500">Issue Terminal</dt>
                                            <dd class="text-sm font-medium text-gray-900">{{
                                                selectedTicket.Issue_Terminal ||
                                                'N/A' }}</dd>
                                        </div>
                                        <div class="flex justify-between">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <dd>
                                                <span
                                                    :class="['px-2 py-0.5 rounded text-xs font-medium', selectedTicket.Is_SMS_Sent ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-600']">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <dd>
                                                <span
                                                    :class="['px-2 py-0.5 rounded text-xs font-medium', selectedTicket.Is_Return ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-600']">
