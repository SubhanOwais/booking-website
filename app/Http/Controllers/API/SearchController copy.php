...
class SearchController extends Controller
{
                    ...
                    try {
                        ...
                        if (!empty($farePoolRequests)) {
                            try {
                                ...
                                // Continue with empty fare responses — base fare will be used as fallback
                            }
                        }
                        ...
                        foreach ($grouped as $serviceTypeId => $serviceGroup) {
                            try {
                                ...
                                // Skip this service type — continue building others
                                continue;
                            }
                        }
                        ...
                        // Continue to next company — never let one failure kill the stream
                        continue;
                    }
                }
    ...
    private function applyDiscountToTrip(array $trip, float $pct): array
    {
        try {
            ...
            return $trip; // Return unmodified trip rather than crashing
        }
    }
