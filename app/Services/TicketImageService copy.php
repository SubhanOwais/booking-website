...
class TicketImageService
{
    ...
    private function generateTicketHtml($data, $ticketUrl)
    {
        ...
        $boardingPoint = htmlspecialchars($data['collection_point'] ?? 'Main Terminal');
    ...
    <style>
        ...
        * {
        ...
        .passenger-table th, .payment-table th {
            background: linear-gradient(to bottom, #7F114D, #5a0c36);
            color: white;
            padding: 12px 10px;
            text-align: left;
            font-weight: 700;
        ...
        .main-note {
            ...
            line-height: 1.5;
            box-shadow: 0 2px 4px rgba(192,0,0,0.1);
        }
        .Ticket-deail-box {
            border: 3px solid #7F114D;
            padding: 20px;
        ...
        .top-section {
            ...
            margin-bottom: 20px;
            padding-bottom: 15px;
            border-bottom: 2px dashed #7F114D;
        }
        .top-left {
            width: 70%;
        }
        ...
        .qr-box {
            ...
            background: white;
            border-radius: 8px;
            box-shadow: 0 4px 8px rgba(127, 17, 77, 0.2);
        }
        .qr-code-img {
            width: 120px;
            height: 120px;
        ...
        .section-title {
            ...
            color: #7F114D;
            padding-bottom: 0px;
            /* border-bottom: 2px solid #7F114D; */
            text-transform: uppercase;
            letter-spacing: 1px;
            position: relative;
        }
        ...
        <div class="top-section">
            <div class="top-left">
                ...
                <div class="company-name">
                    {$companyName} <br>
                    <div style="font-weight: bold; color: #7F114D; font-size: 11px;">For assistance, call: {$helpline}</div>
                </div>
            ...
            <div class="ticket-flex">
                <div class="ticket-left">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">{$boardingPoint}</span>
                    </div>
                    <div class="detail-row">
